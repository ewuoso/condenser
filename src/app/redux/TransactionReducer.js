...
const BROADCAST_OPERATION = 'transaction/BROADCAST_OPERATION';
const UPDATE_AUTHORITIES = 'transaction/UPDATE_AUTHORITIES';
const UPDATE_META = 'transaction/UPDATE_META';
